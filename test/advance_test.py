...
def advance_session():
    ...
    stime = time.time()
    advance_session = grader.GradingSession(grader.normal_handler, latency=0.01, spiffy=True,
                                            topo_map="test/tmp5/topo5.map", nodes_map="test/tmp5/nodes5.map")
    advance_session.add_peer(1, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-1.fragment", 100,
                             ("127.0.0.1", 48001), timeout=None)
    advance_session.add_peer(2, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-2.fragment", 100,
                             ("127.0.0.1", 48002), timeout=None)
    advance_session.add_peer(7, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-3.fragment", 100,
                             ("127.0.0.1", 48003), timeout=None)
    advance_session.add_peer(14, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-4.fragment", 100,
                             ("127.0.0.1", 48004), timeout=None)
    advance_session.add_peer(10, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-5.fragment", 100,
                             ("127.0.0.1", 48005), timeout=None)
    advance_session.add_peer(15, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-6.fragment", 100,
                             ("127.0.0.1", 48006), timeout=None)
    advance_session.add_peer(12, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-7.fragment", 100,
                             ("127.0.0.1", 48007), timeout=None)
    advance_session.add_peer(13, "src/peer.py", "test/tmp5/nodes5.map", "test/tmp5/fragments/data5-8.fragment", 100,
                             ("127.0.0.1", 48008), timeout=None)
    ...
    while True:
        if os.path.exists("test/tmp5/results/result1.fragment") and os.path.exists("test/tmp5/results/result2.fragment") \
                and os.path.exists("test/tmp5/results/result3.fragment") and os.path.exists(
